...
tape('stringify - "email=foo%20bar-xyz@gmail.com"', function (t) {
  var parsed = [
        { key: 'email', value: 'foo%20bar-xyz@gmail.com' }
  ]
  t.equal(url.stringify(parsed), 'email=foo%20bar-xyz@gmail.com')
  t.end()
})
