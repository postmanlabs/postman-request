...
export class Request extends EventEmitter {
    ...
    constructor(options: RequestOptions){
        ...
        const newoptions: http2.ClientSessionOptions | http2.SecureClientSessionOptions = {...options.agentOptions}
        ...
        this._req = client.request({[http2.constants.HTTP2_HEADER_PATH]: path, [http2.constants.HTTP2_HEADER_METHOD]: method, ...headers })
        this._client = client;
